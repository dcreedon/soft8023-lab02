...
def run():
    ...
    config = {'starting_total': 501}

    match1 = stub.CreateMatch(darts_match_pb2.MatchRequest(userName='Alice', matchType='X01', config=config)).matchId
    ...
    match2 = stub.CreateMatch(darts_match_pb2.MatchRequest(userName='Bobby', matchType='X01', config=config)).matchId
