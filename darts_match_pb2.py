...
_MATCHREQUEST_CONFIGENTRY = _descriptor.Descriptor(
  name='ConfigEntry',
  full_name='app.MatchRequest.ConfigEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='app.MatchRequest.ConfigEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='app.MatchRequest.ConfigEntry.value', index=1,
...
_MATCHREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='config', full_name='app.MatchRequest.config', index=2,
  ...
  nested_types=[_MATCHREQUEST_CONFIGENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MATCHREQUEST_CONFIGENTRY.containing_type = _MATCHREQUEST
_MATCHREQUEST.fields_by_name['config'].message_type = _MATCHREQUEST_CONFIGENTRY
...
MatchRequest = _reflection.GeneratedProtocolMessageType('MatchRequest', (_message.Message,), {
  ...
  'ConfigEntry' : _reflection.GeneratedProtocolMessageType('ConfigEntry', (_message.Message,), {
    'DESCRIPTOR' : _MATCHREQUEST_CONFIGENTRY,
    '__module__' : 'darts_match_pb2'
    # @@protoc_insertion_point(class_scope:app.MatchRequest.ConfigEntry)
    })
  ,
...
_sym_db.RegisterMessage(MatchRequest.ConfigEntry)
...
_MATCHREQUEST_CONFIGENTRY._options = None
